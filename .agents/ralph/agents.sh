...
AGENT_GLM_CMD="claude -p --dangerously-skip-permissions --settings ~/.claude/zai-settings.json \"\$(cat {prompt})\""
AGENT_GLM_INTERACTIVE_CMD="claude --dangerously-skip-permissions --settings ~/.claude/zai-settings.json {prompt}"
